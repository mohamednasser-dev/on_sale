...
<div class="col-lg-12 col-12 layout-spacing">
    ...
    <div class="form-group mb-4">
        ...
        <input required type="text" name="name" class="form-control" id="name" placeholder="{{ __('messages.manager_name') }}" value="{{ $data['manager']['name'] }}" >
    </div>

    <div class="form-group mb-4">
        <label for="email">{{ __('messages.manager_email') }}</label>
        <input required type="Email" class="form-control" id="email" name="email" placeholder="{{ __('messages.manager_email') }}" value="{{$data['manager']['email']}}" >
    </div>
    <div class="form-group mb-4">
    ...
    @if($data['manager']['id'] != 1 )
     <div class="row" >
        ...
        <div class="col-md-3" >
             <div class="n-chk">
                <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
                  <input {{ $permission->checked }} name="permission[]" value="{{ $permission->id }}" type="checkbox" class="new-control-input single-permission">
     ...
     <div class="row" >
        ...
        <div class="col-md-3" >
             <div >
                <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
                  <input {{ $data['manager']['add_data'] ? "checked" : "" }} name="add_data" value="1" type="checkbox" class="new-control-input">
        ...
        <div class="col-md-3" >
             <div >
                <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
                  <input {{ $data['manager']['update_data'] ? "checked" : "" }} name="update_data" value="1" type="checkbox" class="new-control-input">
        ...
        <div class="col-md-3" >
             <div >
                <label class="new-control new-checkbox new-checkbox-text checkbox-primary">
                  <input {{ $data['manager']['delete_data'] ? "checked" : "" }}  name="delete_data" value="1" type="checkbox" class="new-control-input">
