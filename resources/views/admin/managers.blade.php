                    ...
                    @foreach ($data['managers'] as $manager)
                        <tr>
                            ...
                            @if(Auth::user()->delete_data && $manager->id != 1)
                                <td class="text-center blue-color" ><a onclick="return confirm('Are you sure you want to delete this item?');" href="/admin-panel/managers/delete/{{ $manager->id }}" ><i class="far fa-trash-alt"></i></a></td>
                            @else
                                <td></td>
                            @endif                                            
                            <?php $i++; ?>
