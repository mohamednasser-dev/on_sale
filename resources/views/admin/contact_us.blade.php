                    ...
                    <tbody>
                        ...
                        @foreach ($data['contact_us'] as $contact_us)
                            <tr class="{{$contact_us->seen == 0 ? 'unread' : '' }}" >
                                ...
                                @if(Auth::user()->delete_data) 
                                    <td class="text-center blue-color" ><a onclick="return confirm('Are you sure you want to delete this item?');" href="/admin-panel/contact_us/delete/{{ $contact_us->id }}" ><i class="far fa-trash-alt"></i></a></td>                                
                                @endif
                                <?php $i++; ?>
                            </tr>
                        @endforeach
