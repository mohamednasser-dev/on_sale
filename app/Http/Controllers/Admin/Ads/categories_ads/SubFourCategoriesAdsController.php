...
class SubFourCategoriesAdsController extends AdminController
{
    ...
    {
        return view('admin.ads.categories_ads.sub_category.sub_two_category.sub_three_category.sub_four_category.create' , compact('id'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.ads.categories_ads.sub_category.sub_two_category.sub_three_category.sub_four_category.ads' , compact('data','id'));
    }
}
