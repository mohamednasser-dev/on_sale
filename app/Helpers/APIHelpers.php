...
class APIHelpers
{
    ...
    public static function send_notification($title, $body, $image, $data, $token)
    {
        ...
        $server_key = "AAAAJ-1EaRQ:APA91bEpfAFtmNeUJNwFozgAIT-aHxGeUwViN40P5Vde1A0wGg6XxNa2f8zv8LTgo3TYo80_ru6eK-tBYXHBhoPWLoZ-1jraYsseeDktLmwJiwyt0kXQLWNKT0Cge2ZzqOcdNzb6xogI";
    ...
    {
        $key = 'AAAAJ-1EaRQ:APA91bEpfAFtmNeUJNwFozgAIT-aHxGeUwViN40P5Vde1A0wGg6XxNa2f8zv8LTgo3TYo80_ru6eK-tBYXHBhoPWLoZ-1jraYsseeDktLmwJiwyt0kXQLWNKT0Cge2ZzqOcdNzb6xogI';
        $fields = array
        (
